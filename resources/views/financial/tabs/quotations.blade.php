...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">{{ __('Quotations') }}</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>#{{ $order->id }}</td>
                        <td>{{ $order->employer ? $order->employer->employerNameTh : __('No Employer (Per-Unit Quote)') }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center text-muted py-4">{{ __('No quotations found.') }}</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
