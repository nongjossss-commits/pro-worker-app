...
@if(request('unpriced') == 1)
    <div class="alert alert-info d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('finance.index', array_merge(request()->except('unpriced'), ['tab' => 'registration'])) }}" class="btn btn-sm btn-outline-info">{{ __('Clear Filter') }}</a>
    </div>
@endif
...
@if(request('billing_status'))
    ...
    <div class="alert alert-warning d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('finance.index', array_merge(request()->except('billing_status'), ['tab' => 'registration'])) }}" class="btn btn-sm btn-outline-warning">{{ __('Clear Filter') }}</a>
    </div>
@endif
