                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($order->employer)
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="loadFinancialTabModal('{{ route('production.renewal.finance.tab', $order->employer->id) }}', '{{ $order->employer->employerNameTh }}')">
