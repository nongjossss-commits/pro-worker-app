...
<div class="content-section">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="mb-3">
                <label class="form-label fw-bold">{{ __('สังกัดนายจ้าง:') }}</label>
    ...
    <div class="row g-3">
            ...
            @if($employee->medical_certificate_path)
                <p class="form-control-plaintext">
                    <a href="#" onclick="event.preventDefault(); viewPDF('{{ Storage::disk('public')->url($employee->medical_certificate_path) }}', 'ดูใบรับรองแพทย์')" class="btn btn-success btn-sm text-white">
                        <i class="bi bi-eye-fill"></i> {{ __('ดูเอกสาร') }}
                    </a>
        ...
        @if($employee->{{ __('insurance_type === 'ประกันสังคม')') }}<div class="col-md-4">
        ...
        @elseif($employee->{{ __('insurance_type === 'ประกันโรงพยาบาล')') }}<div class="col-md-4">
        ...
        @elseif($employee->{{ __('insurance_type === 'ประกันเอกชน')') }}<div class="col-md-4">
    ...
    <div class="row g-3">
        @php
            ...
            $attachmentFields = [
                '1' => ['field' => 'employee_doc_1', 'label' => __('1. พาสปอร์ต')],
                '2' => ['field' => 'employee_doc_2', 'label' => __('2. วีซ่า')],
                '3' => ['field' => 'employee_doc_3', 'label' => __('3. ใบอนุญาต Work Permit')],
                '4' => ['field' => 'employee_doc_4', 'label' => __('4. บัตรชมพู')],
                '5' => ['field' => 'employee_doc_5', 'label' => __('5. ทร. 38')],
                '6' => ['field' => 'employee_doc_6', 'label' => __('6. รายงานตัว 90 วัน')],
                '7' => ['field' => 'employee_doc_7', 'label' => __('7. ใบแจ้งที่พักอาศัย')],
                '8' => ['field' => 'employee_doc_8', 'label' => __('8. เอกสารบ้านเกิด')],
                '9' => ['field' => 'employee_doc_9', 'label' => __('9. เอกสารอื่นๆ 1'), 'desc_field' => 'other_doc_1_desc'],
                '10' => ['field' => 'employee_doc_10', 'label' => __('10. เอกสารอื่นๆ 2'), 'desc_field' => 'other_doc_2_desc'],
                '11' => ['field' => 'employee_doc_11', 'label' => __('11. เอกสารอื่นๆ 3'), 'desc_field' => 'other_doc_3_desc'],
                '12' => ['field' => 'employee_doc_12', 'label' => __('12. เอกสารอื่นๆ 4'), 'desc_field' => 'other_doc_4_desc'],
                '13' => ['field' => 'employee_doc_13', 'label' => __('13. เอกสารอื่นๆ 5'), 'desc_field' => 'other_doc_5_desc'],
                '14' => ['field' => 'employee_doc_14', 'label' => __('14. เอกสารอื่นๆ 6'), 'desc_field' => 'other_doc_6_desc'],
                '15' => ['field' => 'employee_doc_15', 'label' => __('15. เอกสารอื่นๆ 7'), 'desc_field' => 'other_doc_7_desc'],
                '16' => ['field' => 'employee_doc_16', 'label' => __('16. เอกสารอื่นๆ 8'), 'desc_field' => 'other_doc_8_desc'],
                '17' => ['field' => 'employee_doc_17', 'label' => __('17. เอกสารอื่นๆ 9'), 'desc_field' => 'other_doc_9_desc'],
                '18' => ['field' => 'employee_doc_18', 'label' => __('18. เอกสารอื่นๆ 10'), 'desc_field' => 'other_doc_10_desc'],
            ];
        @endphp
