...
@php
    $sections = [
        ['key' => 'sales',               'title' => '🛒 การขาย — Sales (ใบเสนอราคา)'],
        ['key' => 'finance',             'title' => '💰 การเงิน — Finance (Ledger / Tax / WHT)'],
        ['key' => 'financial_profiles',  'title' => '🏷️ โปรไฟล์การเงิน — Financial Profiles'],
    ];
@endphp
