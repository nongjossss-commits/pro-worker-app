    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('pdfBuilder', () => {
            ...
            return {
                ...
                { group: 'Employee Personal', key: 'employeeTitleEn', label: 'Title (EN)' },
                ...
                { group: 'Employee Personal', key: 'employee_id_number', label: 'ID Card No' },
                { group: 'Employee Personal', key: 'tax_id_number', label: 'Tax ID' },
                { group: 'Employee Personal', key: 'height', label: 'Height (cm)' },
                { group: 'Employee Personal', key: 'weight', label: 'Weight (kg)' },
                { group: 'Employee Personal', key: 'bank_name', label: 'Bank Name' },
                { group: 'Employee Personal', key: 'bank_account_number', label: 'Bank Account No' },
                ...
                { group: 'Employee Documents', key: 'passport_issue_place', label: 'Passport Issue Place' },
                { group: 'Employee Documents', key: 'passportType', label: 'Passport Type' },
                { group: 'Employee Documents', key: 'visaType', label: 'Visa Type' },
                { group: 'Employee Documents', key: 'visaExpiryDate', label: 'Visa Expiry' },
                { group: 'Employee Documents', key: 'visa_issue_place', label: 'Visa Issue Place' },
                ...
                { group: 'Employee Documents', key: 'name_list_number', label: 'Name List No' },
                { group: 'Employee Documents', key: 'request_number', label: 'Request No' },

                // Job & Insurance
                { group: 'Job & Insurance', key: 'job_title', label: 'Job Title' },
                { group: 'Job & Insurance', key: 'employeePosition', label: 'Position' },
                { group: 'Job & Insurance', key: 'department', label: 'Department' },
                { group: 'Job & Insurance', key: 'nature_of_work', label: 'Nature of Work' },
                { group: 'Job & Insurance', key: 'startDate', label: 'Start Date' },
                { group: 'Job & Insurance', key: 'workAge', label: 'Work Age' },
                { group: 'Job & Insurance', key: 'daysSinceTermination', label: 'Days Since Term.' },
                ...
                { group: 'Job & Insurance', key: 'hospital_name', label: 'Hospital Name' },
                { group: 'Job & Insurance', key: 'insurance_company', label: 'Insurance Company' },
                { group: 'Job & Insurance', key: 'employer_employee_id', label: 'Internal Emp ID' },
                { group: 'Job & Insurance', key: 'employee_reference_id', label: 'Reference ID' },
                ...
                { group: 'Employer Data', key: 'employer.employerId', label: 'Employer ID No' },
                { group: 'Employer Data', key: 'employer.employerTaxId', label: 'Tax ID' },
                { group: 'Employer Data', key: 'employer.employerPhone', label: 'Phone' },
                { group: 'Employer Data', key: 'employer.employerEmail', label: 'Email' },
                { group: 'Employer Data', key: 'employer.businessType', label: 'Business Type' },
                { group: 'Employer Data', key: 'employer.regCapital', label: 'Reg Capital' },
                { group: 'Employer Data', key: 'employer.regDate', label: 'Reg Date' },
                { group: 'Employer Data', key: 'employer.minimum_wage', label: 'Minimum Wage' },
                { group: 'Employer Data', key: 'employer.socialSecurityHospital', label: 'SS Hospital' },
                { group: 'Employer Data', key: 'employer.outsource_re_code', label: 'Outsource Code' },
                ...
                { group: 'Employer Data', key: 'employer.address_th', label: 'Address Full (TH)' },
                { group: 'Employer Data', key: 'employer.address_en', label: 'Address Full (EN)' },
                { group: 'Employer Data', key: 'employer.address_th.addrNo', label: 'Address (TH) - House No' },
                { group: 'Employer Data', key: 'employer.address_th.addrMoo', label: 'Address (TH) - Moo' },
                { group: 'Employer Data', key: 'employer.address_th.addrSoi', label: 'Address (TH) - Soi' },
                { group: 'Employer Data', key: 'employer.address_th.addrRoad', label: 'Address (TH) - Road' },
                { group: 'Employer Data', key: 'employer.address_th.addrSubDistrict', label: 'Address (TH) - Sub-district' },
                { group: 'Employer Data', key: 'employer.address_th.addrDistrict', label: 'Address (TH) - District' },
                { group: 'Employer Data', key: 'employer.address_th.addrProvince', label: 'Address (TH) - Province' },
                { group: 'Employer Data', key: 'employer.address_th.addrZipCode', label: 'Address (TH) - Zip Code' },
                { group: 'Employer Data', key: 'employer.address_en.addrNoEn', label: 'Address (EN) - House No' },
                { group: 'Employer Data', key: 'employer.address_en.addrMooEn', label: 'Address (EN) - Moo' },
                { group: 'Employer Data', key: 'employer.address_en.addrSoiEn', label: 'Address (EN) - Soi' },
                { group: 'Employer Data', key: 'employer.address_en.addrRoadEn', label: 'Address (EN) - Road' },
                { group: 'Employer Data', key: 'employer.address_en.addrSubDistrictEn', label: 'Address (EN) - Sub-district' },
                { group: 'Employer Data', key: 'employer.address_en.addrDistrictEn', label: 'Address (EN) - District' },
                { group: 'Employer Data', key: 'employer.address_en.addrProvinceEn', label: 'Address (EN) - Province' },
                { group: 'Employer Data', key: 'employer.address_en.addrZipCodeEn', label: 'Address (EN) - Zip Code' },
