        ...
        Alpine.data('pdfBuilder', () => {
            ...
            return {
                ...
                dummyData: {
                    ...
                    'employeeDob_month_th': 'ม.ค.',
                    'employeeDob_year_ce': '1993',
                    'employeeDob_year_be': '2536',
                    'employeeDob_be': '01/01/2536',
                    'employeeDob_th_be': '01 ม.ค. 2536',
                    'employeeDob_th_ce': '01 ม.ค. 1993',
                    'employeeDob_en_be': '01 JAN 2536',
                    'employeeDob_en_ce': '01 JAN 1993',
                    ...
                    'passportIssueDate_month_th': 'ม.ค.',
                    'passportIssueDate_year_ce': '2023',
                    'passportIssueDate_year_be': '2566',
                    'passportIssueDate_be': '01/01/2566',
                    'passportIssueDate_th_be': '01 ม.ค. 2566',
                    'passportIssueDate_th_ce': '01 ม.ค. 2023',
                    'passportIssueDate_en_be': '01 JAN 2566',
                    'passportIssueDate_en_ce': '01 JAN 2023',
                    'passportExpiryDate_be': '01/01/2571',
                    'passportExpiryDate_year_be': '2571',
                    'passportExpiryDate_month_th': 'ม.ค.',
                    'passportExpiryDate_th_be': '01 ม.ค. 2571',
                    'passportExpiryDate_th_ce': '01 ม.ค. 2028',
                    'passportExpiryDate_en_be': '01 JAN 2571',
                    'passportExpiryDate_en_ce': '01 JAN 2028',
                    'document_created_date': '01/01/2026',
                    'document_created_date_be': '01/01/2569',
                    'document_created_date_day': '01',
                    'document_created_date_month_en': 'JAN',
                    'document_created_date_month_th': 'ม.ค.',
                    'document_created_date_year_ce': '2026',
                    'document_created_date_year_be': '2569',
                    'document_created_date_th_be': '01 ม.ค. 2569',
                    'document_created_date_th_ce': '01 ม.ค. 2026',
                    'document_created_date_en_be': '01 JAN 2569',
                    'document_created_date_en_ce': '01 JAN 2026',
                    'insurance_detail_hospital': 'โรงพยาบาลกรุงเทพ',
                    'insurance_detail_private': 'AIA ประกันชีวิต',
                    'medical_hospital_name': 'โรงพยาบาลรามาธิบดี',
                    ...
                    'visaType': 'Non-B',
                    'visaEndorsementDate': '01/01/2025',
                    'visaEndorsementNo': 'V123456',
                    'visaExpiryDate': '01/01/2025',
                    'visa_issue_place': 'Bangkok',
                    'employeeWorkPermit': 'WP123456',
                    'workPermitIssueDate': '01/01/2024',
                ...
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_be', label: '{{ __('Date of Birth (BE)') }}' },
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_year_be', label: '{{ __('Date of Birth (Year BE)') }}' },
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_month_th', label: '{{ __('Date of Birth (Month TH)') }}' },
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_th_be', label: '{{ __('Date of Birth (Thai text BE)') }}' },
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_th_ce', label: '{{ __('Date of Birth (Thai text CE)') }}' },
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_en_be', label: '{{ __('Date of Birth (English text BE)') }}' },
                { group: '{{ __('Personal Information') }}', key: 'employeeDob_en_ce', label: '{{ __('Date of Birth (English text CE)') }}' },
                ...
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_be', label: '{{ __('Passport Issue Date (BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_year_be', label: '{{ __('Passport Issue Date (Year BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_month_th', label: '{{ __('Passport Issue Date (Month TH)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_th_be', label: '{{ __('Passport Issue Date (Thai text BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_th_ce', label: '{{ __('Passport Issue Date (Thai text CE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_en_be', label: '{{ __('Passport Issue Date (English text BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportIssueDate_en_ce', label: '{{ __('Passport Issue Date (English text CE)') }}' },
                ...
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_be', label: '{{ __('Passport Expiry Date (BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_year_be', label: '{{ __('Passport Expiry Date (Year BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_month_th', label: '{{ __('Passport Expiry Date (Month TH)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_th_be', label: '{{ __('Passport Expiry Date (Thai text BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_th_ce', label: '{{ __('Passport Expiry Date (Thai text CE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_en_be', label: '{{ __('Passport Expiry Date (English text BE)') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'passportExpiryDate_en_ce', label: '{{ __('Passport Expiry Date (English text CE)') }}' },
                ...
                { group: '{{ __('Passport & Visa') }}', key: 'visaEndorsementDate', label: '{{ __('Visa Endorsement Date') }}' },
                { group: '{{ __('Passport & Visa') }}', key: 'visaEndorsementNo', label: '{{ __('Visa Endorsement No') }}' },
                ...
                { group: '{{ __('Work Permit & Pink Card') }}', key: 'workPermitIssueDate', label: '{{ __('Work Permit Issue Date') }}' },
                ...
                { group: '{{ __('Insurance') }}', key: 'insurance_detail_hospital', label: '{{ __('Hospital Insurance Name') }}' },
                { group: '{{ __('Insurance') }}', key: 'insurance_expiry_date_hospital', label: '{{ __('Hospital Insurance Expiry Date') }}' },
                { group: '{{ __('Insurance') }}', key: 'insurance_detail_private', label: '{{ __('Private Insurance Company') }}' },
                { group: '{{ __('Insurance') }}', key: 'insurance_expiry_date_private', label: '{{ __('Private Insurance Expiry Date') }}' },
                { group: '{{ __('Insurance') }}', key: 'medical_hospital_name', label: '{{ __('Medical Check-up Hospital') }}' },
                { group: '{{ __('Insurance') }}', key: 'hospital_name', label: '{{ __('Hospital Name (Legacy)') }}' },
                { group: '{{ __('Insurance') }}', key: 'insurance_company', label: '{{ __('Private Insurance Company (Legacy)') }}' },
