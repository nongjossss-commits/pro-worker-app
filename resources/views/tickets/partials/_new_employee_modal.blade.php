    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form @submit.prevent="submitNewEmployeeForm" id="newEmployeeActualForm" class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="modal_employeeTitleTh" class="form-label">คำนำหน้าชื่อ (ไทย) <span class="text-danger">*</span></label>
                                <select class="form-select" id="modal_employeeTitleTh" x-model="newEmployeeForm.employeeTitleTh" required>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="modal_employeePassport" class="form-label">เลขพาสปอร์ต <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="modal_employeePassport" x-model="newEmployeeForm.employeePassport" required>
                    </div>
                    <div class="col-md-4 mb-3">
