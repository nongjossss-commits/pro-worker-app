        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h6 class="text-primary border-bottom pb-2 mb-3">ข้อมูลส่วนตัว</h6>
                ...
                <h6 class="text-primary border-bottom pb-2 mb-3 mt-2">ข้อมูลหนังสือเดินทาง & วีซ่า</h6>
                <div class="row g-2 mb-3">
                    <div class="col-md-4">
                ...
                {{-- Work Permit Section --}}
                <h6 class="text-primary border-bottom pb-2 mb-3 mt-2">ข้อมูลใบอนุญาตทำงาน</h6>
                <div class="row g-2 mb-3">
                    <div class="col-md-6">
                ...
                {{-- Insurance Section --}}
                <h6 class="text-primary border-bottom pb-2 mb-3 mt-2">ข้อมูลประกัน</h6>
                <div class="row g-2 mb-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <label class="fw-bold small">รายละเอียด/เลขที่:</label>
                        <div id="preview_insurance_detail" class="text-dark"></div>
                    </div>
                </div>

                {{-- Documents Section --}}
                <h6 class="text-primary border-bottom pb-2 mb-3 mt-2">เอกสารแนบ</h6>
...
<script>
    function openNewEmployeePreview(data) {
        if (!data) return;
        ...
        let insuranceDetail = '-';
        if (data.insurance_type === 'ประกันสังคม') insuranceDetail = data.social_security_number + ' ' + (data.insurance_detail_social || '');
        else if (data.insurance_type === 'ประกันโรงพยาบาล') insuranceDetail = data.insurance_detail_hospital;
        else if (data.insurance_type === 'ประกันเอกชน') insuranceDetail = data.insurance_detail_private;
        ...
        for (const [key, label] of Object.entries(docLabels)) {
            ...
            if (data[urlKey]) {
                ...
                col.innerHTML = `
                    <a href="${data[urlKey]}" target="_blank" class="btn btn-outline-secondary w-100 text-start text-truncate">
