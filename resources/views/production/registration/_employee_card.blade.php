        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
            ...
            <div class="ms-md-2 w-100" style="max-width: 100%;" x-data="{
                ...
                <div class="w-100" style="min-width: 0;">
                    ...
                    <div x-show="isEditing" @click.outside="isEditing = false" class="flex-column gap-2 p-2 bg-white border rounded shadow-sm position-absolute" style="display: none; z-index: 1060; width: calc(100% - 30px); max-width: 300px;">
