            ...
            <div class="modal-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="autoMouInput">
                        ...
                        <option value="MOU 2 ปีหลัง" {{ ($resolutionSettings['registration_auto_mou_group'] ?? '') == 'MOU 2 ปีหลัง' ? 'selected' : '' }}>{{ __('MOU 2 ปีหลัง') }}</option>
                        <option value="มติต่ออายุในประเทศ" {{ ($resolutionSettings['registration_auto_mou_group'] ?? '') == 'มติต่ออายุในประเทศ' ? 'selected' : '' }}>{{ __('มติต่ออายุในประเทศ') }}</option>
                        <option value="มติขึ้นทะเบียน" {{ ($resolutionSettings['registration_auto_mou_group'] ?? '') == 'มติขึ้นทะเบียน' ? 'selected' : '' }}>{{ __('มติขึ้นทะเบียน') }}</option>
                        <option value="อื่นๆ" {{ ($resolutionSettings['registration_auto_mou_group'] ?? '') == 'อื่นๆ' ? 'selected' : '' }}>{{ __('อื่นๆ') }}</option>
                    </select>
                </div>
            </div>
