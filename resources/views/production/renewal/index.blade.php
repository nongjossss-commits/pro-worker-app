                    ...
                    <div class="d-flex justify-content-center mb-2">
                        <div class="position-relative w-50 text-center" x-data="{
                            ...
                            <div x-show="!editing" style="display: none;">
                                <div class="p-2 border rounded bg-white shadow-sm d-flex align-items-center justify-content-center cursor-pointer" @click="editing = true" style="min-height: 40px;">
