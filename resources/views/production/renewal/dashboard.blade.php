...
<div class="container-fluid py-4" x-data="calendarApp()">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('production.renewal.operations', ['resolutionTab' => $currentTab->id]) }}" class="btn btn-primary shadow-sm fw-bold">
                                    ...
                                    @foreach($upcomingAppointments as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end pe-4">
                                                <a href="{{ route('production.renewal.operations', ['resolutionTab' => $currentTab->id]) }}"
    ...
    function calendarApp() {
        return {
            ...
            openDay(dateStr) {
                ...
                fetch(`{{ route('production.renewal.api.appointments_by_date', ['resolutionTab' => $currentTab->id]) }}?date=${dateStr}&_t=${Date.now()}`)
                    .then(res => res.json())
                    .then(data => {
