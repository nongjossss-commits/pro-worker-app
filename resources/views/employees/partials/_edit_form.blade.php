    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                    ...
                    <select class="form-select" id="edit_employeeTitleEn" name="employeeTitleEn">
                            <option value="Mr." @selected(old('employeeTitleEn', $employee->employeeTitleEn) == 'Mr.')>{{ __('Mr.') }}</option>
                            <option value="Miss" @selected(old('employeeTitleEn', $employee->employeeTitleEn) == 'Miss')>{{ __('Miss') }}</option>
                            <option value="Mrs." @selected(old('employeeTitleEn', $employee->employeeTitleEn) == 'Mrs.')>{{ __('Mrs.') }}</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="edit_employeeNameEn" class="form-label">{{ __('Full Name (EN)') }}<span class="text-danger">*</span>
        ...
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="d-grid gap-2 w-75">
                ...
                @if($employee->{{ __('employeePhoto)') }}<button type="button" class="btn btn-sm btn-warning"
                        onclick="window.openCropperWithUrl('{{ asset('storage/' . $employee->employeePhoto) }}', 'edit_employeePhotoInput', 'edit_employeePhotoPreview')">
                    <i class="bi bi-pencil-square me-1"></i>{{ __('แก้ไขรูปภาพ') }}</button>
                @endif
            </div>
            {{-- Hidden file inputs --}}
