...
class ImporterController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'signature_1_path' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:30720',
            'signature_2_path' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:30720',
            'importer_stamp_path' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:30720',
            'importer_doc_other_1' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'importer_doc_other_1_desc' => 'nullable|string|max:255',
            'importer_doc_other_2' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'importer_doc_other_2_desc' => 'nullable|string|max:255',
            'importer_doc_other_3' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
